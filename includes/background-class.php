...
class Tax_Custom_Background {
	...
	function init() {
		...
		$this->page = $page = add_theme_page(__('Theme Backgrounds'), __('Theme Backgrounds'), 'edit_theme_options', 'custom-background', array(&$this, 'admin_page'));
